    ...
    <>
      ...
      <div className="bg-white p-6 text-gray-800">
        <div className="mx-auto max-w-4xl">
          <br></br>
          <p className="mb-4">
            Welcome to the developer&apos;s corner of HiddenGemz! This project
            is brought to you by a passionate team of developers dedicated to
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="flex flex-col items-center rounded-lg bg-gray-100 p-4 text-center shadow-xl">
              ...
              <p className="text-left text-sm">
                ...
                projects and figuring things out as I go. I like keeping things
                simple, experimenting with new tech, and improving UI/UX along
            ...
            <div className="flex flex-col items-center rounded-lg bg-gray-100 p-4 text-center shadow-xl">
              ...
              <p className="text-left text-sm">
                ...
                in software development. During my time at Dev Academy Aotearoa,
                I gained hands-on experience with databases, APIs, React, and
            ...
            <div className="flex flex-col items-center rounded-lg bg-gray-100 p-4 text-center shadow-xl">
              ...
              <p className="text-left text-sm">
                ...
                databases, turning concepts into working features while learning
                how everything connects end to end. I enjoy keeping things
                clean, solving problems step by step, and improving both the
