  ...
  return (
    <div>
      ...
      <div
        ...
        className="flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-teal-400 shadow-md transition duration-150 hover:scale-110 active:scale-125"
      >
        <svg
          className="h-6 w-6"
          role="img"
